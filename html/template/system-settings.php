...
<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/system-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Sep 2025 06:10:36 GMT -->
<head>
		...
		<script src="assets/js/theme-script.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>
    ...
    <body>
					...
					<div class="page-wrapper-new p-0">
						<div class="content">
							<div class="modal-header">
								<div class="page-title">
									<h4 class="fs-18 fw-bold">Configure Google Captcha</h4>
								</div>
				...
				<div class="modal-content">
					<div class="page-wrapper-new p-0">
						<div class="content">
							<div class="modal-header">
								<div class="page-title">
									<h4 class="fs-18 fw-bold">Configure Google Analytics</h4>
								</div>
								<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
				...
				<div class="modal-content">
					<div class="page-wrapper-new p-0">
						<div class="content">
							<div class="modal-header">
								<div class="page-title">
									<h4 class="fs-18 fw-bold">Configure Google Adsense Code</h4>
								</div>
								<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
		...
		<!-- Google Map -->
		<div class="modal fade" id="configure-google-map">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="page-wrapper-new p-0">
						<div class="content">
							<div class="modal-header">
								<div class="page-title">
									<h4 class="fs-18 fw-bold">Configure Google Map ID</h4>
								</div>
								<button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
		...
		<!-- jQuery -->
        <script src="assets/js/jquery-3.7.1.min.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>

        <!-- Feather Icon JS -->
		<script src="assets/js/feather.min.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="assets/js/jquery.slimscroll.min.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>

		<!-- Datatable JS -->
		<script src="assets/js/jquery.dataTables.min.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>
		<script src="assets/js/dataTables.bootstrap5.min.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="assets/js/bootstrap.bundle.min.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>
		
		<!-- Datetimepicker JS -->
		<script src="assets/js/moment.min.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>
		<script src="assets/js/bootstrap-datetimepicker.min.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>

		<!-- Quill JS -->
    <script src="assets/plugins/quill/quill.min.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="assets/plugins/select2/js/select2.min.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>

		<!-- Sticky-sidebar -->
		<script src="assets/plugins/theia-sticky-sidebar/ResizeSensor.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>
		<script src="assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>

		<!-- Color Picker JS -->
		<script src="assets/plugins/%40simonwep/pickr/pickr.es5.min.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>

		<!-- Custom JS -->
		<script src="assets/js/theme-colorpicker.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>
		<script src="assets/js/script.js" type="f6ea414fe6f9e839b493cd6f-text/javascript"></script>

	
    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="f6ea414fe6f9e839b493cd6f-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"98610d94b95aef4a","version":"2025.9.1","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from dreamspos.dreamstechnologies.com/html/template/system-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Sep 2025 06:10:37 GMT -->
</html>