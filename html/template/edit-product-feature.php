...
include "../../includes/session.php";
    ...
    $feature = fetchProductFeatureById($conn, $productID);

    if (!$feature)  {
        echo "product featue not found.";
    }
} else {
...
<body>
						...
						<div class="accordions-items-seperate" id="accordionSpacingExample">
							<div class="accordion-item border mb-4">
								...
								<div id="SpacingOne" class="accordion-collapse collapse show" aria-labelledby="headingSpacingOne">
									...
									<div class="row">
    <!-- Hidden ID -->
    <input type="hidden" value="<?php echo $feature['id']; ?>" name="id">

    <!-- Product -->
    <div class="col-sm-6 col-12">
        <div class="mb-3">
            <label class="form-label">Product <span class="text-danger ms-1">*</span></label>
            <select class="select" name="product_id" required disabled>
                ...
                <?php if (!empty($products)): ?>
                    <?php foreach ($products as $product): ?>
                        <option 
                            ...
                            <?php echo ($product['id'] == $feature['product_id']) ? 'selected' : ''; ?>>
    ...
    <div class="col-sm-6 col-12">
        <div class="mb-3">
            ...
            <select class="select" name="feature_type" required disabled>
                <option value="">Select</option>
                <option value="interior" <?php echo ($feature['is_interior'] == 1) ? 'selected' : ''; ?>>Interior</option>
                <option value="exterior" <?php echo ($feature['is_exterior'] == 1) ? 'selected' : ''; ?>>Exterior</option>
                <option value="limited" <?php echo ($feature['is_limited'] == 1) ? 'selected' : ''; ?>>Limited</option>
                <option value="inclusive" <?php echo ($feature['is_included'] == 1) ? 'selected' : ''; ?>>Included</option>
            </select>
        </div>
    </div>
