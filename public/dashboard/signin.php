...
<body class="account-page bg-white">
        ...
        document.querySelector("#loginForm").addEventListener("submit", function(e) {
            ...
            fetch("process/login.php", {
                ...
                .then(data => {
                    ...
                    // Show toast at top
                    toastEl.className =
                        `toast align-items-center text-white border-0 ${data.status === "success" ? "bg-success" : "bg-danger"}`;
    ...
    <!-- Force hide loader -->
    <script>
        // Ensure loader is hidden even if other scripts fail
        $(window).on('load', function() {
            $('#global-loader').fadeOut('slow');
        });
        // Backup: hide after 2 seconds regardless
        setTimeout(function() {
            $('#global-loader').fadeOut('slow');
        }, 2000);
    </script>
